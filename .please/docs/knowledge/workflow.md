...
> Development workflow conventions for @please-auth.
...
bun run --filter '@please-auth/waitlist' dev
...
bun run --filter '@please-auth/waitlist' test
```
...
- Test complete user flows with better-sqlite3 in-memory database
- Verify data transactions
- Test authentication and authorization flows

## Commit Guidelines

Follow the project's commit convention (conventional commits via commitlint).

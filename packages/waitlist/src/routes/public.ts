...
export function joinWaitlist(options: WaitlistOptions) {
...
export function getWaitlistStatus(_options: WaitlistOptions) {
  return createAuthEndpoint(
    '/waitlist/status',
    {
      method: 'GET',
...
export function verifyInviteCode(_options: WaitlistOptions) {
  return createAuthEndpoint(

...
function adminMiddleware(options: WaitlistOptions) {
...
export function approveEntry(options: WaitlistOptions) {
...
export function rejectEntry(options: WaitlistOptions) {
  return createAuthEndpoint(
    '/waitlist/reject',
    {
      method: 'POST',
...
export function bulkApprove(options: WaitlistOptions) {
  return createAuthEndpoint(
...
export function listWaitlist(options: WaitlistOptions) {
  return createAuthEndpoint(
    '/waitlist/list',
    {
      method: 'GET',
...
export function getWaitlistStats(options: WaitlistOptions) {
  return createAuthEndpoint(
    '/waitlist/stats',
    {
      method: 'GET',
